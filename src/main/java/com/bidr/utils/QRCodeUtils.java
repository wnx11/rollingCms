...
public class QRCodeUtils {  
     ...
     * @throws Exception  
     */    
    public static String getBase64QRCode(String content,boolean needCompress) {    
        BufferedImage image;
        ByteArrayOutputStream outputStream=outputStream = new ByteArrayOutputStream();
		try {
			image = QRCodeUtils.createImage(content, QRCodeUtils.class.getResource("").getPath()+"//qr.png",    
			        needCompress);
    ...
    public static void main(String[] args) throws Exception {  
        String text = "https://www.rongbin.tech/img/photoUpload/webUpload.html";  //这里设置自定义网站url  
        String logoPath = "d:\\qr.png";   
        String destPath = "d:\\";   
        QRCodeUtils.encode(text, logoPath, destPath, true);
    	System.out.println(getWebAppUrl());
    }  
    ...
    public static String getWebAppUrl(){
    	String classpath = QRCodeUtils.class.getResource("/").getPath().replaceFirst("/", ""); 
